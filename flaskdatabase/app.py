...
sqlazureconnstr_wwif = os.getenv("SQLAZURECONNSTR_WWIF")
...
class ConnectionManager(object):
    ...
    def __getConnection(self):
        if (self.__connection == None):
            ...
            self.__connection = pyodbc.connect(sqlazureconnstr_wwif + application_name)
    ...
    @retry(stop=stop_after_attempt(3), wait=wait_fixed(10), retry=retry_if_exception_type(pyodbc.OperationalError),
